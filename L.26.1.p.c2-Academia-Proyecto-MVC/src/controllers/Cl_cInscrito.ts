...
export default class Cl_cInscrito {
    ...
    private callback!: (inscrito: Cl_mInscrito | null) => void;
    ...
    solicitarInscrito(callback: (inscrito: Cl_mInscrito | null) => void): void {
    ...
    private aceptar(): void {
        ...
        const inscrito = new Cl_mInscrito(
            this.vista.nombre, this.vista.apellido, this.vista.cedula, sexo, fecha, tipo
        );
