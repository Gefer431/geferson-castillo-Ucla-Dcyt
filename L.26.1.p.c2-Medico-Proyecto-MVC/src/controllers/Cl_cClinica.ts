...
export default class Cl_cClinica {
    ...
    private vistaPaciente: I_vPaciente;
    private controladorPaciente: Cl_cPaciente;

    constructor(vistaClinica: I_vClinica, vistaPaciente: I_vPaciente) {
    ...
    private actualizarVista(): void {
        ...
        this.vistaPrincipal.reportarEstadisticas(
            total, totProc, totCons, totCtrl,
            porcProc, porcCons, porcCtrl, porcDesc, promPeso
        );
    }
    ...
    private cargarDatosIniciales(): void {
        ...
        for (const d of datos) {
            ...
            const paciente = new Cl_mPaciente(
                ...
                new Date(d[4] as string), d[5] as number, d[6] as number
            );
